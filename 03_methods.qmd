...
![DBSCAN-TE: Temporal sequence constraint.](parameter_3.png){#fig-parameter_3 width="3.5in"}
...
![DBSCAN-TE: Entropy constraint with (a) low and (b) high entropy.](parameter_4.png){#fig-parameter_4 width="4.25in"}
